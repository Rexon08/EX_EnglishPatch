...
ns.Translations.ModuleStrings.DisplayText = {
    -- Upstream placeholder for an event whose spell has no name in the
    -- client database yet; it reaches the timeline as-is.
    ["事件371"] = "Event 371",
...
ns.Translations.MobSpells.MobNames = {
    ...
    -- ─ Nexus-Point Xenas ─────────────────────────────────────────────
    -- skipped (DNT/unreleased): [[DNT] Conduit Stalker] = [DNT] Conduit Stalker
    ...
    ["复活的妖术师"]   = "Risen Hexer",
    ["鬼魂蛮兵"]     = "Ghostly Brute",
    ["骸骨狩猎迅猛龙"]  = "Skeletal Hunting Raptor",
    ["皇家狂战士"]    = "Royal Berserker",
    ["活化守卫"]     = "Animated Guardian",
    ["净化构造体"]    = "Purification Construct",
    ["拉胡艾大王"]    = "King Rahu'ai",
    ["帕特拉女王"]    = "Queen Patlaa",
    ["荣耀迅猛龙"]    = "Honored Raptor",
    ["守卫队长阿图"]   = "Guard Captain Atu",
    ["提玛吉大王"]    = "King Timalji",
    ["沃希女王"]     = "Queen Wasi",
    ...
    ["宝珠守望者"]   = "Orb Watcher",
    ["暴怒云气"]    = "Agitated Nimbus",
    ["堕落的守护者"]  = "Corrupted Guardian",
    -- review: 风暴飞蛇 (CN name mismatch: 沙鳞突击者)
    ["风暴飞蛇"]    = "Storm Serpent",
    ["流沙猎手"]    = "Sandswept Hunter",
    ["扭曲的妖术师"]  = "Twisted Hexxer",
    ["三叶虫主母"]   = "Krolusk Matriarch",
    ["沙怒石拳战士"]  = "Sandfury Stonefist",
    ["砂誓骑兵"]    = "Sand-Sworn Rider",

    -- ─ Ruby Life Pools ─────────────────────────────────────────────
    ["暴风引导者"]      = "Tempest Channeler",
    ["大引导者莱瓦迪"]    = "High Channeler Ryvati",
    ["灰烬先知烈焰鞭笞者"]  = "Ashseer Flamelasher",
    ["毁灭唤风者"]      = "Ruinous Stormbringer",
    ["雷霆之颅"]       = "Thunderhead",
    ["烈焰之咽"]       = "Flamegullet",
    ["闪霜织寒者"]      = "Flashfrost Chillweaver",
    ["亵渎者德拉加尔"]    = "Defier Draghar",
    ["炎缚毁灭者"]      = "Blazebound Destroyer",
    ["炎缚火焰风暴"]     = "Blazebound Firestorm",
    ["原始主宰"]       = "Primal Juggernaut",

    -- ─ Murder Row ─────────────────────────────────────────────
    ["被买通的守卫"]   = "Bribed Guard",
    ["腐化的术士"]    = "Corrupted Warlock",
    ["巨大的邪能浮龙"]  = "Massive Felwyrm",
    ["破坏魔惩罚者"]   = "Shivan Punisher",
    ["邪能主宰鲁科西"]  = "Felmaster Lucsei",
    ["亵渎傀儡"]     = "Defiled Golem",

    -- ─ Den of Nalorakk ─────────────────────────────────────────────
    ["寒冬暴风雪"]     = "The Winter Squall",
    ["饥渴之灵"]      = "Spirit of Hunger",
    ["决意化身"]      = "Avatar of Determination",
    ["老练的战争使者"]   = "Grizzled Warbringer",
    ["神灵代言人纳尼亚"]  = "Loa Speaker Nanea",

    -- ─ The Blinding Vale ─────────────────────────────────────────────
    ["孢荒喷射者"]     = "Sporeblight Belcher",
    ["翠绿林地守护者"]   = "Virid Grovekeeper",
    ["发光的棘喉兽"]    = "Luminous Thornmaw",
    ["薯身蟾主母"]     = "Potatoad Matriarch",
    ["长得过大的多头花"]  = "Overgrown Hydra",

    -- ─ Voidscar Arena ─────────────────────────────────────────────
    ["不屈的埃吉拉"]    = "Aegyra the Unyielding",
    ["布鲁托克"]      = "Brutok",
    ["法术风暴拉杰克斯"]  = "Raj'kess the Spellstorm",
    ["几丁高斯"]      = "Chitigoth",
    ["焦躁的虚镰"]     = "Agitated Voidscythe",
    ["警惕的掠心者"]    = "Watchful Harrower",
    ["鲁莽监督者"]     = "Brutal Overseer",
    ["贪噬残虐者"]     = "Devouring Brutalizer",
    ["虚触法师"]      = "Voidtouched Magi",

    -- ─ Altar of Fangs ─────────────────────────────────────────────
    ["高阶进化者"]    = "High Evolutionist",
    ["晋升之蛇"]     = "Ascendant Serpent",
    ["双牙蹂躏者"]    = "Twinfang Harrower",
...
-- Exact-match-only display strings. These keys are too short to join the
-- substring pass (a bare 2-glyph key would substitute inside longer
-- untranslated strings and player names), but as whole-string dropdown /
-- toggle values they are safe: Resolver.DisplayText consults this table
-- only when the entire FontString text equals the key.
ns.Translations.ModuleStrings.ExactOnly = {
    ["默认"] = "Default",   -- font-style dropdown stored value
